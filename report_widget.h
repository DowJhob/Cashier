...
class report_widget : public QDialog
{
    Q_OBJECT
public:
    report_widget(QWidget* parent = nullptr, QList<QStringList> EventList = {} ) : QDialog( parent,   Qt::WindowTitleHint | Qt::WindowSystemMenuHint ) //: QWidget( parent )
    {
        //setParent(parent);
        setLayout(&lay);
